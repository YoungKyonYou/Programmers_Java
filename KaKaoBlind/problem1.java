...
public class problem1 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        int k2 = 3;
        int k3 = 1;
        int[] ans=solution(id_list3,report3, k3);
    ...
    public static int[] solution(String[] id_list, String[] report, int k) {
        ...
        //누가 누구한테 신고했는지 저장 
        HashMap<String, String> whoReportedMap = new HashMap<>();
        ...
        for (int i = 0; i < report.length; i++) {
            ...
            if (whoReportedMap.containsKey(tempFrom)) {
                ...
                String target = whoReportedMap.get(tempFrom);
                ...
                whoReportedMap.put(tempFrom, tempTo);
            }
        ...
        for (int i = 0; i < id_list.length; i++) {
            if (whoReportedMap.containsKey(id_list[i])) {
                int cnt = 0;
                String temp = whoReportedMap.get(id_list[i]);
